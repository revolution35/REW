...
import SELL_ABI from 'abis/sell.json'
import REW_ABI from 'abis/rew.json'
import {
...
export function useREWContract(lotteryAddress?: string) {
  return useContract(lotteryAddress, REW_ABI, false)
}

export function useLotteryWalesContract(lotteryAddress?: string, withSignerIfPossible?: boolean ): Contract | null {
  return useContract(lotteryAddress, SELL_ABI, withSignerIfPossible)
}
