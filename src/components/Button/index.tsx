...
`
export const Button3dOrange = styled(BaseButton)`
  background-color: #F37A2D;
  
  color: white;
  left: 20px;
  // box-shadow: 0 0 0 2px white, 0 0.4em 0 0 white};
  ...
  transform: translate3d(0, 0.4em, -1em) skew(3deg, 0deg);
  ::before {
    position: absolute;
    content: "";
    width: 100%;
    ...
    border: 1px solid #1F0D35;
    left: -5px;
    box-shadow: 0 0 0 0.2px ${({ theme }) => theme.textPrimary}, -4px 0.15em 0 0 #FEBD23;    transform: translate3d(0, 0.2em, -1em) ;
    transition: all 55ms cubic-bezier(1, 0, 1, 1);
  }
  &:hover {
    transform: translate(-0.1em, 0.42em)  skew(3deg, 0deg);
    &:hover::before {
    left: -4px;
    box-shadow: 0 0 0 0.2px ${({ theme }) => theme.textPrimary}, -4px 0.15em 0 0 #FEBD23;
     }
  &:active {
    transition: all 55ms cubic-bezier(0, 0, 1, 1);
  transform: translate(-0.1em, 0.5em) skew(1deg, 0deg) scale(0.99);
}
  &:active::before {
    left: -3px;
   box-shadow: 0 0 0 0.7px ${({ theme }) => theme.textPrimary}, 0px 0.1em 0 0 #FEBD23; 
  }
`

export const Button3dDark = styled(BaseButton)`
  ...
  ::before {
    ...
    background: #1F0D35;
    border-radius: inherit;
    border: 1px solid #FEBD23;
    box-shadow: 0 0 0 0px #1F0D35, -5px 5px 0 0 #1F0D35, 0px 0px 0px 0px #FEBD23, -6px 6px 0px 0px #FEBD23;
  ...
  &:hover::before {
    left: -5px;
    box-shadow: 0 0 0 0.8px #1F0D35, -4px 0.15em 0 0 #1F0D35,  0px 0px 0px 0px #FEBD23, -4.5px 4.5px 0px 0px #FEBD23;
     }
  &:active {
    transition: all 45ms cubic-bezier(0, 0, 1, 1);

  transform: translate(-0.1em, 0.5em) skew(1deg, 0deg) scale(0.99);
}
  &:active::before {
    left: -3px;
   box-shadow: 0 0 0 0.7px #1F0D35, 0px 0.1em 0 0 #1F0D35; 
  }
`
export const Button3dPurp = styled(BaseButton)`
  ...
  ::before {
    ...
    border-radius: inherit;
    border: 1px solid #FEBD23;
    box-shadow: 0 0 0 0px #FEBD23, -5px 5px 0 0 #492E8B, 0px 0px 0px 0px #FEBD23, -6px 6px 0px 0px #FEBD23;
    transform: translate3d(0, 0.25em, -1em);
    transition: all 45ms cubic-bezier(1, 0, 1, 1);
  }
  &:hover {
     transform: translate(-0.1em, 0.42em)  skew(3deg, 0deg);
  &:hover::before {
    left: -5px;
    box-shadow: 0 0 0 0.8px #1F0D35, -4px 0.15em 0 0 #492E8B,  0px 0px 0px 0px #FEBD23, -5px 5px 0px 0px #FEBD23;
     }
  &:active {
    transition: all 45ms cubic-bezier(0, 0, 1, 1);
  ...
  &:active::before {
    left: -3px;
   box-shadow: 0 0 0 0.7px #1F0D35, 0px 0.1em 0 0 #492E8B; 
  }
